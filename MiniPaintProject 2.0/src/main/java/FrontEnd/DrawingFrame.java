...
public class DrawingFrame extends javax.swing.JFrame implements Node{
    ...
    private void initComponents() {
        ...
        drawingPanel = new FrontEnd.DrawingPanel(this);
    ...
    private void rectangleButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rectangleButtonActionPerformed
        ...
        RectangleProperties rectangleProperties = new RectangleProperties(rectangle);
        rectangleProperties.setParentNode(this);
        rectangleProperties.setVisible(true);
        this.setVisible(false); 
        drawingPanel.addShape(rectangle);
        drawingPanel.refresh(null);
        jComboBox1.addItem("rectangle" + drawingPanel.getShapes().length);
