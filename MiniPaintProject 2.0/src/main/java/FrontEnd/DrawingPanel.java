...
public class DrawingPanel extends javax.swing.JPanel implements DrawingEngine, MouseListener, MouseMotionListener{
    ...
    protected SublimeShape draggedShape;
    ...
    public void mousePressed(MouseEvent e) {
        ...
        for(Shape shape : shapes){
            if(((SublimeShape)shape).contains(e.getPoint())){
                frame.getCombobox().setSelectedIndex(shapes.indexOf(shape));
                draggedShape = (SublimeShape)shape;
