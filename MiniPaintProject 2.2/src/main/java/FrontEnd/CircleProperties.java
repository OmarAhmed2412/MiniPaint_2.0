...
public class CircleProperties extends javax.swing.JFrame implements Node{
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(raduisTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 55, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void addCircleButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addCircleButtonActionPerformed
        if(centerXCorTextField.getText().equals("") || centerYCorTextField.getText().equals("") || raduisTextField.getText().equals(""))
            JOptionPane.showMessageDialog(null, "Some fields are empty");
        else{
            if(isIntger(centerXCorTextField.getText()) && isIntger(centerYCorTextField.getText()) && isIntger(raduisTextField.getText()))
            {
        //int circleCounter = 0;
        ...
        Circle circle = new Circle(new Point(xCor, yCor), radius);
        circle.setFillColor(this.fillColor);
        circle.setColor(this.borderColor);
        DrawingFrame.getPanel().addShape(circle);
        DrawingFrame.getPanel().refresh(null);
        DrawingFrame.getCombobox().addItem("Circle" + DrawingFrame.getPanel().getShapes().length);
